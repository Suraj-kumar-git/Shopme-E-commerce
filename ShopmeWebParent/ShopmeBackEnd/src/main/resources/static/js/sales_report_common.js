...
function setSalesAmount(period, reportType, labelTotalItems) {
    ...
    $("#textTotalGrossSales" + reportType).addClass("text-primary");
    $("#textTotalNetSales" + reportType).addClass("text-primary");
    $("#textAvgGrossSales" + reportType).addClass("text-muted");
    $("#textAvgNetSales" + reportType).addClass("text-muted");
    $("#textTotalItems" + reportType).addClass("text-muted");
}
